...
export default function AdminCommandes(){
    ...
    if(loading) return <div className="card"><div className="card-body">Chargement des commandes…</div></div>;
                ...
                {commandes.length ? commandes.map(c => (
                    <div className="card" key={c.id}>
                        <div className="card-body">
                            ...
                            <div>Quantité: {c.quantite ?? c.total ?? '—'}</div>
                        </div>
                    </div>
                )) : <div className="card"><div className="card-body">Aucune commande</div></div>}
            </div>
        </div>
    );
}
